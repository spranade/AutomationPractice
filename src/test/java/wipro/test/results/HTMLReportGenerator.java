package wipro.test.results;

import static wipro.test.modules.Operations.logger;
import static wipro.test.modules.Operations.report;
...
//		{logger.log(LogStatus.INFO,StepName, StepDetails);}
	...
	public static void main(String[] args) throws UnknownHostException {
		TestSuiteStart(System.getProperty("user.dir") + "\\report.html", "ejagruti");
